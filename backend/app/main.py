...
from app.modules.tokenx.router import router as tokenx_router
...
for router in (auth_router, dashboard_router, wallet_router, api_keys_router, models_router, account_router, admin_router, tool_setup_router, tokenx_router):
