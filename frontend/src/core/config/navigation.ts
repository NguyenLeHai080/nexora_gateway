...
export const navigation: NavigationItem[] = [
  { label: 'API key & TokenX', path: '/admin/user-api-keys', icon: KeyRound, roles: ['super_admin'], guide:{title:'API key & khóa nguồn',description:'Quản lý API key theo tài khoản và khóa upstream TokenX.',steps:['Chọn tài khoản để cấp khóa Nexora.','Mở tab TokenX để quản lý khóa nguồn.','Không chia sẻ khóa nguồn trực tiếp cho khách hàng.']} },
  ...
  { label: 'TokenX & Pool', path: '/admin/tokenx', icon: Cloud, roles: ['super_admin'], guide:{title:'TokenX & Pool',description:'Theo dõi kết nối TokenX, đối soát và map model vào pool.',steps:['Kiểm tra kết nối upstream.','Map model TokenX vào routing pool.','Xem khóa ở menu API key và chi phí ở Dòng tiền.']} },
