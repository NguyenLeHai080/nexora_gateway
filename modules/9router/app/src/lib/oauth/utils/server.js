...
const CODEX_CALLBACK_HOST = process.env.OAUTH_CALLBACK_HOST || "127.0.0.1";
...
export function startCodexProxy(appPort) {
  return new Promise((resolve) => {
    ...
    server.listen(CODEX_PORT, CODEX_CALLBACK_HOST, () => {
...
const XAI_CALLBACK_HOST = process.env.OAUTH_CALLBACK_HOST || "127.0.0.1";
...
export function startXaiProxy(appPort) {
  return new Promise((resolve) => {
    ...
    server.listen(XAI_PROXY_PORT, XAI_CALLBACK_HOST, () => {
